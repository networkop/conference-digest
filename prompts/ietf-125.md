>>> HOW TO RUN THIS <<<
This is the digest prompt for ietf-125. If you are a Claude session with
filesystem access to the conference-digest repo, you can read this same
file directly from `prompts/ietf-125.md` instead of having it pasted.
...
Below is the program for IETF 125 (Shenzhen) (standards). Read it and produce a digest
...
<!--
conference: IETF 125 (Shenzhen)
type: standards
source_url: https://datatracker.ietf.org/meeting/125/agenda.json
generated: 2026-09-14
registry_key: ietf-125
-->
...
### Automated Certificate Management Environment (ACME) Extension for Proof-of-Possession  (draft-ietf-acme-pop)
The Automated Certificate Management Environment (ACME) protocol
...
### The Purpose Declined HTTP Status Code  (draft-ietf-httpbis-pre-denied)
This specification defines an HTTP status code to indicate that the
...
### An EAT Profile for Trustworthy Device Assignment  (draft-poirier-rats-eat-da)
