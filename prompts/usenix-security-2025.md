>>> HOW TO RUN THIS <<<
This is the digest prompt for usenix-security-2025. If you are a Claude session with
filesystem access to the conference-digest repo, you can read this same
file directly from `prompts/usenix-security-2025.md` instead of having it pasted.
Produce the digest below and SAVE IT as a markdown file at exactly:
    digests/usenix-security-2025.md
...
Below is the program for USENIX Security '25 (34th USENIX Security Symposium) (academic). Read it and produce a digest
...
Shirley Zhang, University of Wisconsin–Madison; Paul Chung, University of California, San Diego; Jacob Vervelde, Nishant Korapati, Rahul Chatterjee, and Kassem Fawaz, University of Wisconsin–Madison
...
Xiao Zhan, King's College London; Juan Carlos Carrillo, VRAIN, Universitat Politècnica de València; William Seymour, King's College London; Jose Such, King's College London and VRAIN, Universitat Politècnica de València
...
Kimberly Ruth and Raymond Buernor Obu, Stanford University; Ifeoluwa Shode, Fisk University; Gavin Li, Stanford University; Carrie Gates, FS-ISAC; Grant Ho, University of Chicago; Zakir Durumeric, Stanford University
...
Enigma Track 1
Ballroom 6B
The Power of Community: Insights and Opportunities
Darren Shou, RSAC

Available Media
Hide details  ▾  
Understanding the cyber-security landscape, its current state and trajectory, the challenges in the field, as well as the direction of cutting-edge research and innovation, is a difficult endeavor that is critical for the future of technology and humanity at large. An essential element of gaining this visibility and understanding is found in the community: experts get together, share knowledge, opinions, and points of view, and collectively define the landscape as a living organism. The power of community is central to a healthy, vibrant, and effective ecosystem.

As the custodians of one of the largest gatherings of cyber-security experts, we share the responsibility of fostering and supporting community, providing opportunities for fertile engagement, and enabling the continuity and vibrancy of engagement in a 24/7/365 world. As a result, we have unique insights into the landscape and its direction that we share back with the community, while also trying to invent new ways to enable additional opportunities for engagement.

In this talk, we will discuss some of the recent trends and insights we have observed in the cyber-security space, provide a view on the evolution of different areas of interest, and propose new ways to strengthen community.


Darren Shou is the Chief Strategy Officer at RSAC. Darren was previously CTO at Gen Digital (f.k.a NortonLifeLock) where he helped the company grow to over 500M users with innovative new products and integrating companies such as Avast and Avira. Prior to serving as CTO, Darren was in product development leadership roles at Symantec and Microsoft. He is a global keynote speaker, a contributor at WIRED, and has been featured in major media outlets such as the Wall Street Journal, Financial Times, and CNN.

Please (Don't) Stop the Music: Adversarial Red-Teaming of AI Music Generation Models
...
Nan Yan and Yuqing Li, Wuhan University; Xiong Wang, Huazhong University of Science and Technology; Jing Chen and Kun He, Wuhan University; Bo Li, Hong Kong University of Science and Technology
...
Minkyoo Song, Hanna Kim, Jaehan Kim, Seungwon Shin, and Sooel Son, KAIST
...
Daniel Olszewski, Tyler Tucker, Kevin R. B. Butler, and Patrick Traynor, University of Florida
...
Ahmed Lekssays and Hamza Mouhcine, Qatar Computing Research Institute; Khang Tran, New Jersey Institute of Technology; Ting Yu, Mohamed bin Zayed University of Artificial Intelligence; Issa Khalil, Qatar Computing Research Institute
...
Tingwei Zhang, Collin Zhang, and John X. Morris, Cornell Tech; Eugene Bagdasarian, University of Massachusetts Amherst; Vitaly Shmatikov, Cornell Tech
...
Antoine Delignat-Lavaud, Cédric Fournet, Kapil Vaswani, Manuel Costa, and Sylvan Clebsch, Azure Research, Microsoft; Christoph M. Wintersteiger, Imandra
...
Enigma Track 3
Ballroom 6B
Security Theater Is Canceled: Time for a Real Show
Lea Kissner, LinkedIn

Available Media
Hide details  ▾  
Real-world security is a human-driven challenge that demands cross-functional collaboration—not just from security teams, but also from partners like SRE, Trust, and Legal—because most security goals (like reliability and accountability) are shared across disciplines. From hacker pipelines like Scattered Spider, to the complexities of cryptography as key management, to the dark realities of ransomware and state-sponsored actors, security is deeply entangled with people, systems, and incentives. The lesson: security isn’t just about fixing bugs—it’s about understanding motivations, building alliances with partners and stakeholders across the org, and designing systems that make doing the right thing the easy thing.


Lea Kissner is the Chief Information Security Officer (CISO) at LinkedIn. With over two decades of leadership in security, privacy, and anti-abuse technologies, Kissner has held senior roles at Google (Global Lead, Privacy Technology), Twitter (CISO & Head of Privacy Engineering), Lacework (CISO), and Humu (Chief Privacy Officer), served as a consultant to Zoom during its rapid security scaling in 2020. They hold a Ph.D. in Computer Science (specializing in cryptography) from Carnegie Mellon University and a B.S. in Electrical Engineering & Computer Science from UC Berkeley. Known for pioneering in the field of privacy engineering, contributing to systems like Google’s Zanzibar and BeyondProd, Kissner is also a board member of USENIX. At LinkedIn, Lea brings a thoughtful, user-centric approach to security—centered on protecting members, customers, and employees by integrating security deeply into platform systems.
...
Adam Shostack is a leading expert on threat modeling, founder of Shostack + Associates, the author of Threat Modeling: Designing for Security and Threats: What Every Engineer Should Learn from Star Wars. Helped create the CVE. Now an Emeritus member of the Advisory Board. Shostack serves as a member of the Blackhat Review Board, an advisor to a variety of companies and academic institutions, and an Affiliate Professor at the Paul G. Allen School of Computer Science and Engineering at the University of Washington.
...
Tian Dong and Yan Meng, Shanghai Jiao Tong University; Shaofeng Li, Southeast University; Guoxing Chen, Zhen Liu, and Haojin Zhu, Shanghai Jiao Tong University
...
Philipp Mackensen, Ruhr University Bochum; Christian Niesler, University of Duisburg-Essen; Roberto Blanco, Eindhoven University of Technology/MPI-SP; Lucas Davi, University of Duisburg-Essen; Veelasha Moonsamy, Ruhr University Bochum
...
Xuanming Liu, Zhelei Zhou, and Yinghao Wang, Zhejiang University; Yanxin Pang, Tsinghua University; Jinye He, University of Virginia; Bingsheng Zhang and Xiaohu Yang, Zhejiang University; Jiaheng Zhang, National University of Singapore
...
Rajdeep Ghosh, Shiladitya De, and Mainack Mondal, IIT Kharagpur
...
Elizabeth Lin, Sparsha Gowda, William Enck, and Dominik Wermke, NC State University
...
Inside Out: Security Designed With, Not For
...
Yong Yang, Zhejiang University; Changjiang Li, Stony Brook University; Qingming Li, Oubo Ma, Haoyu Wang, Zonghui Wang, Yandong Gao, Wenzhi Chen, and Shouling Ji, Zhejiang University
...
Hannes Weissteiner and Fabian Rauscher, Graz University of Technology; Robin Leander Schröder, Fraunhofer SIT and Fraunhofer Austria; Jonas Juffinger and Stefan Gast, Graz University of Technology; Jan Wichelmann and Thomas Eisenbarth, University Luebeck; Daniel Gruss, Graz University of Technology
...
Yuhui Zhu, Scuola Superiore Sant'Anna and Scuola IMT Alti Studi Lucca; Alessandro Biondi, Scuola Superiore Sant'Anna
...
Yiming Zhu, Wenchao Huang, and Yan Xiong, University of Science and Technology of China
...
Yiheng Zhang, Ming Wen, and Shunjie Liu, Huazhong University of Science and Technology; Dongjie He, Chongqing University; Hai Jin, Huazhong University of Science and Technology
...
Connect: 
Mastadon
Zombie Devices Are Running Amuck!
...
Mingyuan Fan, East China Normal University; Fuyi Wang, RMIT University; Cen Chen, East China Normal University; Jianying Zhou, Singapore University of Technology and Design
...
Zihao Wang, Nanyang Technological University; Rui Zhu and Dongruo Zhou, Indiana University Bloomington; Zhikun Zhang, Zhejiang University; XiaoFeng Wang, Nanyang Technological University; Haixu Tang, Indiana University Bloomington
...
Felix Stöger, ETH Zurich; Henry Birge-Lee, Princeton University; Giacomo Giuliari, Mysten Labs; Jordi Subira-Nieto and Adrian Perrig, ETH Zurich
...
Panel: Winners of the 2025 USENIX Security Test of Time Award
...
Yu Pan and Wanjing Han, University of Utah; Yue Duan, Singapore Management University; Mu Zhang, University of Utah
...
Yuxin (Myles) Liu, Habiba Farrukh, and Ardalan Amiri Sani, UC Irvine; Sharad Agarwal, Microsoft; Gene Tsudik, UC Irvine
...
Youngjoon Kim and Sunguk Shin, Korea University; Hyoungshick Kim, Sungkyunkwan University; Jiwon Yoon, Korea University
...
Armin Sarabi, Ziyuan Huang, Chenlan Wang, Tai Karir, and Mingyan Liu, University of Michigan
...
Pratap Singh, Carnegie Mellon University; Joshua Gancher, Northeastern University; Bryan Parno, Carnegie Mellon University
...
7:00 pm–8:00 pm
Open Forum with the Program Co-Chairs
Ballroom 6C
...
Mikaela Brough and Rikke Bjerg Jensen, Royal Holloway, University of London; Martin R. Albrecht, King's College London
...
Emmanuel Tweneboah, Max Planck Institute for Security and Privacy; Collins W. Munyendo, Max Planck Institute for Security and Privacy and The George Washington University; Yixin Zou, Max Planck Institute for Security and Privacy
...
Jhih-Yi (Janet) Hsieh, Aditi Raghunathan, and Nihar B. Shah, Carnegie Mellon University
...
Shijie Luo, Matheus Garbelini, Sudipta Chattopadhyay, and Jianying Zhou, Singapore University of Technology and Design
...
Maryam Motallebighomi, Jason Veara, Evangelos Bitsikas, and Aanjhan Ranganathan, Northeastern University
...
Mohamed Suliman, IBM Research and Trinity College Dublin, The University of Dublin; Anisa Halimi, Swanand Ravindra Kadhe, and Nathalie Baracaldo, IBM Research; Douglas Leith, Trinity College Dublin, The University of Dublin
...
Minhao Bai, Kaiyi Pang, Guorui Liao, Jinshuai Yang, and Yongfeng Huang, Tsinghua University
...
Divyanshu Bhardwaj and Sumair Ijaz Hashmi, CISPA Helmholtz Center for Information Security, Saarland University; Katharina Krombholz and Maximilian Golla, CISPA Helmholtz Center for Information Security
...
Yuxi Wu, Northeastern University; Ruoxi Zhang, Shiyue Liu, Mufei He, and Aidan Hong, Carnegie Mellon University; Jeremy J. Northup, Point Park University; Calla Kainaroi, Bridge to the Mountains; Fei Fang and Hong Shen, Carnegie Mellon University
...
Filipo Sharevski, DePaul University; Verena Distler, Aalto University; Florian Alt, Ludwig Maximilians Universität, University of the Bundeswehr Munich
...
Vincenzo Carletti, Pasquale Foggia, Carlo Mazzocca, Giuseppe Parrella, and Mario Vento, University of Salerno
...
Available Media
Hide details  ▾  
Video calls have become an essential part of remote work. They enable employees to collaborate from different locations, including their home. Transmitting video from the personal living environment, however, poses a privacy risk: Colleagues may gain insight into private information through details in the background. To limit this risk, video conferencing services implement virtual backgrounds that conceal the real environment during a video call. Unfortunately, this protection suffers from imperfections and pixels from the environment occasionally become visible.
...
Xin Yao and Kecheng Huang, Central South University; Yimin Chen, University of Massachusetts Lowell; Jiawei Guo, Jie Tang, and Ming Zhao, Central South University
...
Jay Bosamiya, Microsoft Research; Maverick Woo and Bryan Parno, Carnegie Mellon University
...
Sai Ritvik Tanksalkar, Siddharth Muralee, Srihari Danduri, Paschal Amusuo, Antonio Bianchi, James C. Davis, and Aravind Kumar Machiry, Purdue University
...
Bocheng Xiang, Yuan Zhang, Fengyu Liu, Hao Huang, Zihan Lin, and Min Yang, Fudan University
...
Daniele Coppola, ETH Zurich; Arslan Mumtaz, CISPA – Helmholtz Center for Information Security; Giovanni Camurati and Harshad Sathaye, ETH Zurich; Mridula Singh, CISPA – Helmholtz Center for Information Security; Srdjan Capkun, ETH Zurich
...
Neelu S. Kalani, EPFL and IBM Research - Zurich; Thomas Bourgeat, EPFL; Guerney D. H. Hunt, IBM T. J. Watson Research Center; Wojciech Ozga, IBM Research - Zurich
...
Haibo Cheng, Fugeng Huang, and Jiahong Yang, Peking University; Wenting Li, Beijing Institute of Graphic Communication; Ping Wang, Peking University
...
John Y. Kim, Chaoshun Zuo, Yanjie Zhao, and Zhiqiang Lin, The Ohio State University
...
Zeren Luo, Zifan Peng, Yule Liu, and Zhen Sun, The Hong Kong University of Science and Technology (Guangzhou); Mingchen Li, The Hong Kong University of Science and Technology (Guangzhou); University of North Texas; Jingyi Zheng and Xinlei He, The Hong Kong University of Science and Technology (Guangzhou)
...
Lakshmi Likhitha Mankali and Mohammed Nabeel, Tandon School of Engineering, New York University; Faiq Raees, New York University; Michail Maniatakos, Ozgur Sinanoglu, and Johann Knechtel, New York University Abu Dhabi
